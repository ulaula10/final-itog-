...
def draw():
    global img,x,r,img1,p,t,f,a,p,o,c,v
    ...
    fill(180,163,126)
    textSize(55)
    text(u'спасибо за внимание!', c,v)
def mouseClicked():
    global bg, img,x,r,img1,p,t,f,a,p,o,c,v
    if mouseX > 425 and mouseX < 475 and mouseY > 640 and mouseY < 690 and mouseY:
        img = loadImage("fon.png")
        x=-89
        t=-87
        r=30
        f=-39
